...
impl File {
    pub unsafe fn write_at(&self, pointer: *mut u8) -> usize {
        ...
        pointer = pointer.offset(mem::size_of::<File>() as isize);

        mem::size_of::<File>() + self.write_references_at(pointer)
    }
    ...
    pub unsafe fn reconstruct_at_inline(object_pointer: *mut u8) -> usize {
        mem::size_of::<File>() + Self::reconstruct_at(object_pointer as *mut File, object_pointer.offset(mem::size_of::<File>() as isize))
    }

    pub unsafe fn reconstruct_at(object_pointer: *mut File, references_pointer: *mut u8) -> usize {
