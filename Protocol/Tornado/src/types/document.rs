...
impl Document {
    pub unsafe fn write_at(&self, pointer: *mut u8) -> usize {
        ...
        core::ptr::copy(self, pointer as *mut Document, 1);
        pointer = pointer.offset(mem::size_of::<Document>() as isize);

        mem::size_of::<Document>() + self.write_references_at(pointer)
    }
    ...
    pub unsafe fn reconstruct_at_inline(object_pointer: *mut u8) -> usize {
        mem::size_of::<Document>() + Self::reconstruct_at(object_pointer as *mut Document, object_pointer.offset(mem::size_of::<Document>() as isize))
    }

    pub unsafe fn reconstruct_at(object_pointer: *mut Document, references_pointer: *mut u8) -> usize {
