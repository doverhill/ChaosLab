...
impl WriteObjectParameters {
    pub unsafe fn create_at_address(pointer: *mut u8, object_name: &str, object_path: &str, position: u64, length: u64, data_count: usize) -> (usize, ManuallyDrop<Vec<u8>>) {
        let object: *mut WriteObjectParameters = mem::transmute(pointer);
        let pointer = pointer.offset(mem::size_of::<WriteObjectParameters>() as isize);
        ...
        *(pointer as *mut usize) = data_count;
        ...
        // return
        (mem::size_of::<WriteObjectParameters>() + mem::size_of::<usize>() + _object_name_length + mem::size_of::<usize>() + _object_path_length + mem::size_of::<usize>() + data_count * mem::size_of::<u8>(), ManuallyDrop::new(data))
    }
    ...
    pub unsafe fn write_at_address(&self, pointer: *mut u8) -> usize {
        ...
        *(pointer as *mut usize) = data_count;
        ...
        // return
        mem::size_of::<WriteObjectParameters>() + mem::size_of::<usize>() + _object_name_length + mem::size_of::<usize>() + _object_path_length + mem::size_of::<usize>() + data_count * mem::size_of::<u8>()
    }
    ...
    pub unsafe fn get_from_address(pointer: *mut u8) -> (usize, *mut Self) {
        ...
        // return
        (mem::size_of::<WriteObjectParameters>() + mem::size_of::<usize>() + _object_name_length + mem::size_of::<usize>() + _object_path_length + mem::size_of::<usize>() + data_count * mem::size_of::<u8>(), object)
    }
}
