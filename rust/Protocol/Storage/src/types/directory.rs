...
impl Directory {
    pub unsafe fn create_at_address(pointer: *mut u8, name: &str, path: &str) -> usize {
        ...
        let pointer = pointer.offset(mem::size_of::<Directory>() as isize);
        ...
        *(pointer as *mut usize) = _path_length;
        ...
        // return
        mem::size_of::<Directory>() + mem::size_of::<usize>() + _name_length + mem::size_of::<usize>() + _path_length
    }
    ...
    pub unsafe fn get_from_address(pointer: *mut u8) -> (usize, *mut Self) {
        ...
        // return
        (mem::size_of::<Directory>() + mem::size_of::<usize>() + _name_length + mem::size_of::<usize>() + _path_length, object)
    }
}
