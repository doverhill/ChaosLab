...
impl File {
    pub unsafe fn create_at_address(pointer: *mut u8, name: &str, path: &str, size: u64) -> usize {
        let object: *mut File = mem::transmute(pointer);
        let pointer = pointer.offset(mem::size_of::<File>() as isize);
        ...
        *(pointer as *mut usize) = _path_length;
        ...
        // return
        mem::size_of::<File>() + mem::size_of::<usize>() + _name_length + mem::size_of::<usize>() + _path_length
    }

    pub unsafe fn write_at_address(&self, pointer: *mut u8) -> usize {
        core::ptr::copy(self, pointer as *mut File, 1);
        let pointer = pointer.offset(mem::size_of::<File>() as isize);
    ...
    pub unsafe fn get_from_address(pointer: *mut u8) -> (usize, *mut Self) {
        ...
        // return
        (mem::size_of::<File>() + mem::size_of::<usize>() + _name_length + mem::size_of::<usize>() + _path_length, object)
    }
}
