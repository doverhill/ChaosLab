...
impl GridLayout {
    pub unsafe fn create_at_address(pointer: *mut u8, component_id: u64, parent_component_id: u64) -> usize {
        let object: *mut GridLayout = mem::transmute(pointer);
        let pointer = pointer.offset(mem::size_of::<GridLayout>() as isize);
